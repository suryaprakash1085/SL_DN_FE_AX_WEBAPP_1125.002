...
export default function serviceCenter() {
  ...
  useEffect(() => {
    fetchEntries(setEntries, setFilteredEntries, setLoading, setError,setNotFound);
  }, []);
                    ...
                    >
                      ...
                      >
                        ...
                        <Typography variant="body2" color="text.secondary">
                          Date:{" "}
                          {new Date(tile.appointment_date).toLocaleDateString()}
                        </Typography>
                        <Typography variant="body2" color="text.secondary">
